                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Data Master Siswa</div>
                        </div>
                        <div class="card-body table-responsive">
                            <a href="{{ route('create-data-siswa') }}">
                                    ...
                                    @if ($siswas)
                                        @foreach ($siswas as $index => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item['nis'] }}</td>
                                                <td>{{ $item['nama'] }}</td>
                                                <td>{{ isset($item['kelas']['nama_kelas']) ? $item['kelas']['nama_kelas'] : '' }}</td>
                                                <td>
                                                    <a href="{{ route('edit-siswa', ['id' => $item['nisn']]) }}"
                                                    ...
                                                    <form action="{{ route('softdelete-data-siswa', $item['nisn']) }}"
